...
@section("body")
    ...
    <form action="{{ route('ticket.store') }}" method="POST" style="background:#EBF4FF; padding:20px; border-radius:10px; width:400px; font-family:Arial, sans-serif; color:#1E3A8A;">
        @csrf
